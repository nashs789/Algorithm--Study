...
package Programmers.Lv1.Q1;

import java.util.Arrays;

public class Q1_NightWeapons {
    public static void main(String[] args) {
        ...
        for(int idx = 0; idx < nightsArr.length; idx++){
            nightsArr[idx] += getDivisor(idx + 1, limit, power); // index starts from zero
        }

        System.out.println(Arrays.stream(nightsArr).sum());
    }
