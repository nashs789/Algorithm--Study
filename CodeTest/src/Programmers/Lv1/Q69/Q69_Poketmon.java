...
package Programmers.Lv1.Q69;

import java.util.Arrays;
import java.util.HashSet;
import java.util.Set;

public class Q69_Poketmon {
    public static void main(String[] args) {
        int[] nums = {3, 1, 2, 3};

        int maxCapacity = nums.length / 2;
        Set<Integer> pocket = new HashSet(Arrays.asList(Arrays.stream(nums).boxed().toArray(Integer[]::new)));
