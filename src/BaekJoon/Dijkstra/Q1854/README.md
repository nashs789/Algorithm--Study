...
<img width="1147" alt="스크린샷 2023-06-23 오전 1 21 17" src="https://github.com/nashs789/CodeTest/assets/59809278/bc1db244-4460-4c58-a41f-ff84690afe75">
...
<img width="1147" alt="스크린샷 2023-06-23 오전 1 21 31" src="https://github.com/nashs789/CodeTest/assets/59809278/47119b33-7bb4-45da-8cd0-143d1ebd670c">
...
# **[ 접근 순서 ]**
1. k 번째 최단 거리를 어떻게 구할 것인가?
   - 다익스트라 알고리즘은 최단 거리를 구하는 알고리즘을 감안한 자료구조 만들기
      - Priority Queue 배열을 이용한 방법  
         1. 각 요소 인덱스를 노드 번호로 보고, 해당 노드까지 거리를 큐에 넣는다.
         2. 큐의 size 가 k 와 같다면 peek 하여 값을 비교 후 넣을지 넣지 않을지 결정한다.
...
# **[ 결과 ]**
<img width="1147" alt="스크린샷 2023-06-23 오전 1 21 23" src="https://github.com/nashs789/CodeTest/assets/59809278/09860bb9-d690-4a6d-9a93-94aa116a692f">
